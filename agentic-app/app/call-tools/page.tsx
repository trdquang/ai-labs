...
import { ChatMessage } from '../api/call-tools/route';
    ...
    <div className="flex flex-col h-screen bg-gradient-to-br from-gray-50 to-gray-100 dark:from-gray-900 dark:to-gray-800">
      ...
      <header className="bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700 px-6 py-4 shadow-sm">
        <div className="max-w-4xl mx-auto flex items-center gap-3">
          ...
          <div>
            <h1 className="text-xl font-bold text-gray-900 dark:text-white">Call Tools Demo</h1>
            <p className="text-sm text-gray-500 dark:text-gray-400">AI with tool calling capabilities</p>
          </div>
        </div>
      </header>
          ...
          {messages.length === 0 ? (
            <div className="text-center py-12">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-3 max-w-2xl mx-auto">
                <button
                  onClick={() => sendMessage({ text: "What's the weather in Tokyo?" })}
                ...
                <button
                  onClick={() => sendMessage({ text: "What's the weather in London?" })}
                  className="p-4 bg-white dark:bg-gray-800 rounded-lg shadow hover:shadow-md transition-shadow text-left border border-gray-200 dark:border-gray-700"
                >
...
const prompt = `
Generate an e-commerce product JSON based on:
"${productPrompt}"
Return JSON with:
{
  "title": "...",
